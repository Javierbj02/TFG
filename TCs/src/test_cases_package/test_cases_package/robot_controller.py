...
from test_cases_package.Scenario import Scenario
from test_cases_package.generate_plots import GeneratePlots
...
class RobotController(Node):
    def __init__(self):
        ...
        config_file = './test_cases_package/config.json'
        ...
        # self.scenario = self.buildScenario("ULA", "8", "No ruido", "TC3")
    ...
    def save_results(self):
        results = "/home/javi2002bj/Escritorio/TFG_Webots/TFG/TCs/Results/Results " + self.scenario.test_case
