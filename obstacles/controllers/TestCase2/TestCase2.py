...
output_path = main_root + "Test Case 2/Results/" + ruido + "/" + scenario + " " + num_antennas + "/predicciones_" + scenario + num_antennas + ".csv"
...
txt_path = main_root + "Test Case 2/Results/" + ruido + "/" + scenario + " " + num_antennas + "/error_ruta_" + scenario + num_antennas + ".txt"
...
# plt.ylim(1500, 4500)
plt.grid(False)
plt.savefig(main_root + "Test Case 2/Results/" + ruido + "/" + scenario + " " + num_antennas + "/graphic_s_" + scenario + num_antennas + ".png")
...
plt.ylim(1500, 4500)
plt.grid(False)
plt.savefig(main_root + "Test Case 2/Results/" + ruido + "/" + scenario + " " + num_antennas + "/graphic_l_" + scenario + num_antennas + ".png")
